...
**基礎架構分析：**
```
架構分析：我是產品經理，需要向管理層報告系統架構。

請分析 @cloudy-account 模組，提供：
...
```
品質評估：我是產品經理，擔心技術債會影響產品發展速度。

請檢查：@cloudy-files 模組的整體程式碼品質
